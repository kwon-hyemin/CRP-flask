...
class Solution():
    def __init__(self) -> None:
        ...
        self.word_list = list(set(self.sentences))
        # 텐서플로 데이터타입 3가지
        # tuple () , dict {}, list []
        ...
        self.loss = tf.reduce_mean(
            tf.nn.nce_loss(self.nce_weights, self.nce_biases, self.labels, self.selected_embed, self.num_sampled, self.voc_size)
        )
